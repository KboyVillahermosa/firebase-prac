...
function JobCards(props) {
  ...
  return (
    <>
      ...
      <ReactPaginate
        breakLabel={
          <span className="w-10 h-10 mr-4 flex items-center justify-center bg-pink-500 rounded-md active:bg-primary text-white active:text-white hover:border-2 hover:border-primary hover:text-primary border border-solid border-lightGray">
            ...
          </span>
        }
        nextLabel={
        ...
        activeClassName="bg-primary text-pink-500"
