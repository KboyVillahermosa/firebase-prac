...
function JobCard(props) {
  ...
  return (
    <Link to="/job-info" state={{ page: item, pagination: props.pagination }}>
      <div className="w-full flex items-center h-fit gap-2 rounded-md bg-pink-500 text-white mb-6 shadow p-2 sm:gap-4 hover:shadow-lg">
        <img
          src={
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 text-xs w-full sm:flex-nowrap">
            ...
            <div className="flex justify-between gap-1 flex-wrap sm:flex-nowrap sm:gap-4">
              <div className="text-gray-400 truncate flex items-center gap-2">
                <BiWorld className="inline text-white" />
                <span className="text-white">{item.job_country}</span>
              </div>
              <div className="text-white   truncate justify-self-end flex items-center gap-2">
